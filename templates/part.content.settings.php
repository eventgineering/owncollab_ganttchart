...
<div id="sidebar-settings" class="sidebar-left">
    <div id="sidebar-settings-header">
        <div class="tbl">
            <div class="tbl_cell export_gantt sidebar_header colors" data-command="OCGantt.btnAction('setColors')">
                <h4><?php p($l->t('Colors'));?></h4>
            </div>
            <div class="tbl_cell export_gantt sidebar_header" data-command="OCGantt.btnAction('setShare')">
                <h4><?php p($l->t('Share'));?></h4>
            </div>
            <div class="tbl_cell export_gantt sidebar_header" data-command="OCGantt.btnAction('setDisplay')">
